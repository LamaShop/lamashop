...
angular.module('JapanModule',[])
    ...
    .service('dataServiceC1',['$http',function($http){
        return $http.get('json/jsonChoose3.json');
    }])
    .controller('japanCtrl',['$scope','dataServiceC','dataServiceC1',function($scope,dataServiceC,dataServiceC1){
        ...
        $scope.arrShow = [];
        $scope.text =false;
        dataServiceC1.success(function(res){
